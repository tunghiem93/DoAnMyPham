...
namespace CMS_Entity.Mapping
{
    public class CMS_ProductMap : EntityTypeConfiguration<CMS_Products>
    {
        public CMS_ProductMap()
        {
            ...
            this.Property(x => x.Alias).HasMaxLength(250).HasColumnType("nvarchar").IsRequired();
            ...
            this.Property(x => x.LinkVideo).HasMaxLength(500).HasColumnType("nvarchar").IsOptional();
