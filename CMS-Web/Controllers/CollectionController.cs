...
namespace CMS_Web.Controllers
{
    public class CollectionController : HQController
    {
        ...
        private readonly CMSCollectionsFactory _facColl;
        ...
        public CollectionController()
        {
            ...
            _facColl = new CMSCollectionsFactory();
        ...
        public ActionResult Collection2cols()
        {
            try
            {
                ProductViewModels model = new ProductViewModels();
                model.ListCollect = _facColl.GetList().OrderByDescending(x => x.CreatedDate).ToList();
                if (model.ListCollect != null && model.ListCollect.Any())
                {
                    model.ListCollect.ForEach(x =>
                    {
        ...
        public ActionResult Collection2colsDetail()
        {
            try
            {
                ProductViewModels model = new ProductViewModels();
        ...
        public ActionResult Collection3cols()
        {
            try
            {
                ProductViewModels model = new ProductViewModels();
        ...
        public ActionResult Collection3colsDetail()
        {
            try
            {
                ProductViewModels model = new ProductViewModels();
        ...
        public ActionResult Collection4cols()
        {
            try
            {
                ProductViewModels model = new ProductViewModels();
        ...
        public ActionResult Collection4colsDetail()
        {
            try
            {
                ProductViewModels model = new ProductViewModels();
