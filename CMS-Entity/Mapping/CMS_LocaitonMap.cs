...
{
    public class CMS_LocaitonMap : EntityTypeConfiguration<CMS_Locations>
    {
        public CMS_LocaitonMap()
        {
            this.HasKey(x => x.Id);
            ...
            this.Property(x => x.LocationCode).HasMaxLength(50).IsRequired().HasColumnType("varchar");
