...
namespace CMS_DTO.CMSNews
{
    public class CMS_NewsModels : CMS_BaseModel
    {
        ...
        public HttpPostedFileBase PictureUploadAuthor { get; set; }
        public byte[] PictureByteAuthor { get; set; }
        public string ImageURLAuthor { get; set; }
    ...
    public class CMS_NewsViewModel
    {
        ...
        public CMS_NewsModels News { get; set; }
