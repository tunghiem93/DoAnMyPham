...
namespace CMS_Shared.Utilities
{
    ...
    {        
        public static bool SendMailInfor(CMS_CustomerInforModels request)
        {
            var result = true;
            try
            {
                ...
                int portNumber = 587;
                bool enableSSL = true;
                string emailFrom = Commons.EmailSend;
                string password = Commons.PassEmailSend;
                string _emailToAdmin = Commons.EmailReceive;
                using (MailMessage mail = new MailMessage())
                {
                    ...
                    if (!string.IsNullOrEmpty(request.EmailFriend))
                        mail.To.Add(request.EmailFriend);
        ...
        public static bool SendMailOrder(string subject, string body, string emailTo)
        {
            var result = true;
            try
            {
