...
{
    public class CMS_BrandsMap : EntityTypeConfiguration<CMS_Brands>
    {
        public CMS_BrandsMap()
        {
            this.HasKey(x => x.Id);
            this.Property(x => x.Id).HasMaxLength(60).HasColumnType("varchar");
            this.Property(x => x.BrandName).HasMaxLength(250).IsRequired().HasColumnType("nvarchar");
            this.Property(x => x.Alias).HasMaxLength(250).IsRequired().HasColumnType("nvarchar");
            this.Property(x => x.BrandCode).HasMaxLength(50).IsRequired().HasColumnType("varchar");
