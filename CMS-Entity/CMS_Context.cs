...
namespace CMS_Entity
{
    public class CMS_Context : DbContext
    {
        ...
        public virtual DbSet<CMS_Banners> CMS_Banners { get; set; }
        public virtual DbSet<CMS_Locations> CMS_Locations { get; set; }
        public virtual DbSet<CMS_CustomersInfor> CMS_CustomersInfor { get; set; }
        public virtual DbSet<CMS_Collections> CMS_Collections { get; set; }
        public virtual DbSet<CMS_Employee> CMS_Employees { get; set; }
        public virtual DbSet<CMS_Categories> CMS_Categories { get; set; }
        public virtual DbSet<CMS_Brands> CMS_Brands { get; set; }
        ...
        public virtual DbSet<PromotionEntities> Promotions { get; set; }
